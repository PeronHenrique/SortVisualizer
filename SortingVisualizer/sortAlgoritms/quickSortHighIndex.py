...
def quickSortHighIndex(lst: List[int], ascending: bool, lowIndex: int = -1, highIndex: int = -1):
    ...
    #recursive Call
    yield from quickSortHighIndex(lst, ascending, lowIndex, leftPoiter -1)
    yield from quickSortHighIndex(lst, ascending, leftPoiter + 1, highIndex)